"""Add-on preferences for FrameForge."""
...
def _default_output_dir():
    return os.path.join(os.path.expanduser("~"), "FrameForge")


class FrameForgePreferences(AddonPreferences):
    ...
    ffmpeg_path = StringProperty(
        name="ffmpeg Path",
        description=(
            "Leave empty to use the ffmpeg build shipped with FrameForge. "
    ...
    def draw(self, context):
        ...
        if variant.IS_LITE:
            ...
            box.label(text="FrameForge runs fully offline. It makes no network requests.")


CLASSES = (FrameForgePreferences,)
